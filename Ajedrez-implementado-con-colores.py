...
chess = [["---" for x in range(10)] for y in range(10)]
...
def interfaz_inicial():
    ...
    print(Style.BRIGHT + Fore.LIGHTBLUE_EX + "============== CHESS MOBILE ==================")
    print(Style.BRIGHT + Fore.LIGHTYELLOW_EX + "============== BIENVENIDOS ===================")
    print()
    nombres[0][0] = str(input(Fore.LIGHTMAGENTA_EX +"======> NOMBRE DE JUGADOR 1: "))
    nombres[1][0] = str(input(Fore.LIGHTMAGENTA_EX +"======> NOMBRE DE JUGADOR 2: "))
    print()
    print(Style.BRIGHT + Fore.LIGHTRED_EX +"============== SORTEO DE COLOR ============")
    ...
    if nombres[0][1] < nombres[1][1]:
        print(Fore.LIGHTMAGENTA_EX + "------> JUGADOR 2 ====> BLANCAS")
        print(Fore.LIGHTMAGENTA_EX + "------> JUGADOR 1 ====> NEGRAS")
        print(Style.BRIGHT + Fore.WHITE)

    else:
        print(Fore.LIGHTMAGENTA_EX + "------> JUGADOR 1  ====> BLANCAS")
        print(Fore.LIGHTMAGENTA_EX + "------> JUGADOR 2  ====> NEGRAS")
        print(Style.BRIGHT + Fore.WHITE)
...
def turno():
    ...
    if nombres[0][1] < nombres[1][1]:
        if g % 2 == 0:
            print()
            print(Style.BRIGHT + Fore.LIGHTBLUE_EX + "------> TURNO DE : " + nombres[1][0])

        else:
            print()
            print(Style.BRIGHT + Fore.LIGHTBLUE_EX + "------> TURNO DE : " + nombres[0][0])
    else:
        if g % 2 == 0:
            print()
            print(Style.BRIGHT + Fore.LIGHTBLUE_EX + "------> TURNO DE : " + nombres[0][0])
...
def val_cc():
    ...
    while (n > 88 or n == 0 or d > 88 or d == 0):
        n = int(input(Style.BRIGHT + Fore.LIGHTMAGENTA_EX +"POSICIÓN: "))
        d = int(input(Style.BRIGHT + Fore.LIGHTMAGENTA_EX +"Destino: "))
...
def val_peon():
    ...
    if (m[1] == "B"):
        ...
        if (e == "---" and (d == destino[0] or d == destino[1])):
            chess[x][y] = "---"
            chess[w][z] = "PB."
    ...
    if ((n - d) % 11 == 0):
        if n < d:
            ...
            for i in range(tope - 1):
                casilla = d - 11 * (i + 1)
                if chess[casilla // 10][casilla % 10] != "---":
                    k = 0
                else:
                    k = 1
        else:
